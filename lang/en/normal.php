...
return [
    ...
    'student-page-title3' => "Assigned task",
    ...
    'home' => "Home",
    'logout' => "Log out",
    'p1' => "Profile Information",
    'p2' => "Update your account's profile information and email address.",
    'p3' => "Name",
    'p4' => "Email",
    'p5' => "SAVE",
    'p6' => "Update Password",
    'p7' => "Ensure your account is using a long, random password to stay secure.",
    'p8' => "Current Password",
    'p9' => "New Password",
    'p10' => "Confirm Password",
    'p11' => "SAVE",
    'p12' => "Delete Account",
    'p13' => "Once your account is deleted, all of its resources and data will be permanently deleted. Before 
